    ...
    var _tooltip = function(ele,obj){
        ...
        if (text || obj.content){
            ...
            var viewTooltip = function(e){
                ...
                if( _SW_tooltip.hasClass('tinytip-fixed') ){
                    var top = ele.viewportOffset().top + fixY;
                    var left = ele.viewportOffset().left + fixX;
                }
                else
                {
                ...
                if (position == 'bottom'){
                    top = top + ele.outerHeight();
                    left = left + (width/2);
                    left = left - (_SW_tooltip.outerWidth()/2);
                } else if (position == 'left'){
                    left = left - _SW_tooltip.outerWidth();
                    top = top + (ele.outerHeight()/2) - height/2;
                ...
                _SW_tooltip.stop().css({
                    ...
                    opacity: 0,
                    display : ''
                }).animate({ opacity: 0.9, top:top, left:left}, speed, obj.easing, function(){
                    _isview = true;
